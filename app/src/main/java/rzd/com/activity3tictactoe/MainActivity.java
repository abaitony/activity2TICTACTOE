...
//    onclick Button
    ...
    public void resetBtn(){
        mButton1.setText(""); mButton1.setBackgroundResource(R.color.defaultColor);
        mButton2.setText(""); mButton2.setBackgroundResource(R.color.defaultColor);
        mButton3.setText(""); mButton3.setBackgroundResource(R.color.defaultColor);
        mButton4.setText(""); mButton4.setBackgroundResource(R.color.defaultColor);
        mButton5.setText(""); mButton5.setBackgroundResource(R.color.defaultColor);
        mButton6.setText(""); mButton6.setBackgroundResource(R.color.defaultColor);
        mButton7.setText(""); mButton7.setBackgroundResource(R.color.defaultColor);
        mButton8.setText(""); mButton8.setBackgroundResource(R.color.defaultColor);
        mButton9.setText(""); mButton9.setBackgroundResource(R.color.defaultColor);
    }
}
